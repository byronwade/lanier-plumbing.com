...
export default function Reviews(props: ReviewsBlock) {
	const { tagline = "Trust the experts at FlowMasters Plumbing for all your residential and commercial plumbing needs.", platforms = [] } = props;

	return (
		<section className="py-16 bg-white">
			<div className="container px-4 mx-auto">
				<div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
					<p className="max-w-2xl text-lg font-medium text-center lg:text-left lg:text-2xl">{tagline}</p>
