...
const Underwater = () => {
	return (
		<div className="h-screen w-screen bg-gradient-to-b from-[#35597a] via-[#0C201F] to-black overflow-hidden p-4">
			<svg className="absolute w-screen h-screen transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 blur-[10px]" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1000 1000">
